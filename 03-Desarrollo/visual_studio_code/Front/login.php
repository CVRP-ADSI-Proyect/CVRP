                ...
                <div class="p-5">
                  ...
                  <form class="user">
                    <form method="POST" action="loginProceso.php">
                      ...
                      <button type="submit" class="btn btn-info btn-user btn-block" href="sesioniniciada.html">
                        Iniciar Sesión.
                      </button>
                      <!-- <hr>
                  ...
                  <div class="text-center">
                    <a class="small"  href="register.php">Creacion de Cuenta!</a>
                  </div>
                </div>
              </div>
            </div>
