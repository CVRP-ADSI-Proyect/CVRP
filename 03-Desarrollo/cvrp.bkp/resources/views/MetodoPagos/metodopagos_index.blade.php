...
<head>
    ...
    <!-- Favicon icon -->
    <link rel="icon" type="image/png" sizes="16x16" href="images/logo_cvrp.png">
    <title>CVRP</title>
    <!-- Bootstrap Core CSS -->
    <!-- morris CSS -->
    <!-- Custom CSS -->
        ...
        <nav class="navbar top-navbar navbar-expand-md navbar-light">
            ...
            <div class="navbar-header">
                <a class="navbar-brand" href="#">
                    ...
                    <!-- Light Logo icon -->
                        <img src="images/logo_cvrp.png" width="60" height="60" alt="homepage" class="light-logo" style="margin:10px 10px" />
                    </b>
                    <!--End Logo icon -->
                    <!-- Logo text -->
                         <!-- dark Logo text -->
    ...
    <aside class="left-sidebar">
        ...
        <div class="scroll-sidebar">
            ...
            <div class="user-profile">
                <!-- User profile image -->
                <div class="profile-img"> <img src="../" alt="user" />
                    <!-- this is blinking heartbit-->
                    <div class="notify setpos"> <span class="heartbit"></span> <span class="point"></span> </div>
                </div>
                <!-- User profile text-->
                <div class="profile-text">
                    <h5>CVRP - Nuevo Milenio</h5>
            ...
            <nav class="sidebar-nav">
                <ul id="sidebarnav">
                    ...
                    <li> <a class="has-arrow waves-effect waves-dark" href="#" aria-expanded="false"><i class="mdi mdi-gauge"></i><span class="hide-menu">Autenticación <span class="label label-rouded label-themecolor pull-right">4</span></span></a>
    ...
    <div class="page-wrapper">
        ...
        <div class="row page-titles">
            <div class="col-md-5 align-self-center">
                {{--                <h4 class="text-themecolor"><a href="{{route('metodopagos.index')}}">Validar listado de metodo de pagos </a></h4>--}}
                {{--            <a href="{{route('landing.home')}}"><h3 class="text-themecolor">ingreso</h3></a>--}}
            </div>

            <div class="col-md-7 align-self-center">
                <ol class="breadcrumb">
                    <li style="margin-right: 0.5em"><a href="#"> Iniciar Sesión</a></li> /
                    <li style="margin-left: 0.5em"><a href="#"> Registro </a></li>
                </ol>
            </div>
            <div>
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <div class="col-lg-8 col-xlg-9">
                    <div class="card">
                        <div class="card-body">
                            {{--                tablw which show rol list               --}}
                            <div class="container">
                                <div>
                                    {{--                                    class="row"--}}
                                    <div class="col-md-110">
                                        <div class="table-responsive">
                                            <table style="width: 100%; height: auto" border="5" bordercolor="#fff">
                                                <tr>
                                                    <thead>
                                                    <tr>
                                                        <th>ID</th>
                                                        <th>DESCRIPCION METODO DE PAGO</th>
                                                        <th>opciones</th>

                                                    </tr>
                                                    </thead>
                                                @foreach($metodopagos as $Tbl_metododepago)
                                                    <tr>
                                                        <td > {{$Tbl_metododepago->idmetodopago}}</td>
                                                        <td> {{$Tbl_metododepago->descripcionMetodoPago}}</td>
                                                        <td>
        ...
        {{--                    <!-- Column -->--}}
        {{--                    <div class="card">--}}
        {{--                        <div class="card-body bg-inverse" style="background: url(#) / cover;">--}}
