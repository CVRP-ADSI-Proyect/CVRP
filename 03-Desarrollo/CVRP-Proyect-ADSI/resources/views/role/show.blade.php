    ...
    <div class="page-wrapper">
        ...
        <div class="row page-titles">
            <div class="col-md-5 align-self-center">
                {{--                <h4 class="text-themecolor"><a href="{{route('roles.index')}}">Validar listado de roles </a></h4>--}}
                                ...
                                <div>
                                    ...
                                    <div >
                                        <div class="table-responsive">
                                            <table style="width: 100%; height: 100%; text-align: center" border="5" bordercolor="#fff">
                                                <tr>
                                                    <thead>
                                                    <tr>
                                                        <th>Nombre</th>
                                                ...
                                                @foreach($detalles as $tbl_usuario)
                                                    <tr>
                                                        <td > {{$tbl_usuario->primerNombre}}</td>
                                                        <td> {{$tbl_usuario->primerApellido}}</td>
                                                        <td> {{$tbl_usuario->email}}</td>
                                                        <td> {{$tbl_usuario->celular}}</td>
                                                        <td> {{$tbl_usuario->Fk_idRol}}</td>
                                                        <td>
                                                            <a href="#" >Editar</a>
