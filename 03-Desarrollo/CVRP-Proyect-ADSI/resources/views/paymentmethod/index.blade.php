...
<head>
    ...
    <!-- Bootstrap style -->
    <link id="callCss" rel="stylesheet" href="{{url ('css/bootstrap.min.css')}}" media="screen"/>
    ...
    <div class="container">
        ...
        <div id="logoArea" class="navbar">
            ...
            <div class="navbar-inner">
                <a class="brand" href="index.html"><img src="#" alt="Bootsshop"/></a>
...
<script src="../../../public/js/bootshop.js"></script>
