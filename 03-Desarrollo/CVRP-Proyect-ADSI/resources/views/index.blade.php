...
--}}
    ...
    <!-- fav and touch icons -->
    <link rel="shortcut icon" href="themes/images/ico/favicon-cvrp.ico">
...
{{--
            <div class="span6"><strong>Bienvenidos</strong></div>
            <div class="span6">
    ...
    <div class="container">
        <div class="row">
            ...
            <div id="sidebar" class="span3">
                <div class="well well-small"><a id="myCart" href="product_summary.html"><img src="themes/images/ico-cart.png" alt="cart">0 "productos" <span class="badge badge-warning pull-right">$0.0</span></a></div>
                <ul id="sideManu" class="nav nav-tabs nav-stacked">
                    <li class="subMenu open"><a> Electronica [150]</a>
                        <ul>
                            <li><a class="active" href="products.html"><i class="icon-chevron-right"></i>Camaras (100) </a></li>
                            <li><a href="products.html"><i class="icon-chevron-right"></i>Computadores, Tablets & laptop (30)</a></li>
                            <li><a href="products.html"><i class="icon-chevron-right"></i>Celulares (80)</a></li>
                            <li><a href="products.html"><i class="icon-chevron-right"></i>Sonido (15)</a></li>
                        </ul>
                    </li>
                    <li class="subMenu"><a> Joyeria [840] </a>
                        <ul style="display:none">
                            <li><a href="products.html"><i class="icon-chevron-right"></i>Collares (45)</a></li>
                            <li><a href="products.html"><i class="icon-chevron-right"></i>Pulseras (8)</a></li>
                            <li><a href="products.html"><i class="icon-chevron-right"></i>Anillos (5)</a></li>
                            <li><a href="products.html"><i class="icon-chevron-right"></i>Aretes  (45)</a></li>
                            <li><a href="products.html"><i class="icon-chevron-right"></i>Correas (6)</a></li>
                            <li><a href="products.html"><i class="icon-chevron-right"></i>Niños (5)</a></li>
                            <li><a href="products.html"><i class="icon-chevron-right"></i>Bebes (3)</a></li>
                        </ul>
                    </li>
                    <li class="subMenu"><a>Moda [1000]</a>
                        <ul style="display:none">
                            <li><a href="products.html"><i class="icon-chevron-right"></i>Zapatos  (35)</a></li>
                            <li><a href="products.html"><i class="icon-chevron-right"></i>Pantalones (8)</a></li>
                            <li><a href="products.html"><i class="icon-chevron-right"></i>Trajes (5)</a></li>
                            <li><a href="products.html"><i class="icon-chevron-right"></i>Medias  (45)</a></li>
                            <li><a href="products.html"><i class="icon-chevron-right"></i>Sacos (8)</a></li>
            ...
            <div class="span9">
                <div class="well well-small">
                    <h4>Productos relacionados <small class="pull-right">200+ productos relacionados</small></h4>
                    <div class="row-fluid">
                ...
                <h4>Ultimos productos cargados </h4>
                <ul class="thumbnails">
                    <li class="span3">
                        <div class="thumbnail">
                            <a  href="product_details.html"><img src="themes/images/products/6.jpg" alt=""/></a>
...
<div  id="footerSection">
    <div class="container">
        <p style="text-align: center">&copy; CVRP</p>
    </div><!-- Container End -->
</div>
